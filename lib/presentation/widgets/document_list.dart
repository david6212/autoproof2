    ...
    final ok = await showDialog<bool>(
      ...
      builder: (c) => AlertDialog(
        ...
        content: Text(
          ...
          'כתובת או מספר פוליסה. כל מי שמחובר ויצפה במודעה יוכל לראות אותם, '
          'כל עוד המודעה פעילה.\n\n'
          'ביטול השיתוף מפסיק את הגישה מיד. מה שאי אפשר לבטל הוא עותק שמישהו '
          'כבר שמר אצלו.',
          style: AppText.body,
        ),
        actions: [
  ...
  Future<void> _confirmDelete(BuildContext context) async {
    final ok = await showDialog<bool>(
      ...
      builder: (c) => AlertDialog(
        ...
        content: const Text(
          'הקובץ יימחק לצמיתות ולא ניתן לשחזר אותו.',
          style: AppText.body,
        ),
        actions: [
          TextButton(
